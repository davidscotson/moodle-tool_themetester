...
<p><a href="/admin/tool/themetester/docs/4.0/getting-started/download/#npm">Install bootstrap</a> as a Node.js module using npm.</p>

<h2 id="importing-javascript">Importing JavaScript</h2>

<p>Import <a href="/admin/tool/themetester/docs/4.0/getting-started/javascript/">Bootstrap’s JavaScript</a> by adding this line to your app’s entry point (usually <code class="highlighter-rouge">index.js</code> or <code class="highlighter-rouge">app.js</code>):</p>
...
<p>First, create your own <code class="highlighter-rouge">_custom.scss</code> and use it to override the <a href="/admin/tool/themetester/docs/4.0/getting-started/options/">built-in custom variables</a>. Then, use your main sass file to import your custom variables, followed by Bootstrap:</p>
