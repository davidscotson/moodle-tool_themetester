...
$strheading = 'Theme Tester: Bootstrap 4 CSS : Contents';
...
<!-- Facebook -->
<meta property="og:url" content="/docs/4.0/getting-started/contents/">
...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a class="text-warning" href="/admin/tool/themetester/docs/4.0/layout/grid/">Only grid system</a></td>
      <td class="bg-light text-muted">Not included</td>
      <td class="bg-light text-muted">Not included</td>
      <td><a class="text-warning" href="/admin/tool/themetester/docs/4.0/utilities/flex/">Only flex utilities</a></td>
    </tr>
    <tr>
      <th scope="row">
      ...
      <td class="bg-light text-muted">Not included</td>
      <td><a class="text-warning" href="/admin/tool/themetester/docs/4.0/content/reboot/">Only Reboot</a></td>
      <td class="bg-light text-muted">Not included</td>
      <td class="bg-light text-muted">Not included</td>
    </tr>
  </tbody>
