...
<ul>
  ...
  <li>To make the grid responsive, there are five grid breakpoints, one for each <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/layout/overview/#responsive-breakpoints">responsive breakpoint</a>: all breakpoints (extra small), small, medium, large, and extra large.</li>
...
<p>You may also apply this break at specific breakpoints with our <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/utilities/display/">responsive display utilities</a>.</p>
...
<p>In addition to column clearing at responsive breakpoints, you may need to reset offsets. See this in action in <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/examples/grid/">the grid example</a>.</p>
