...
<p>Aligning the figure’s caption is easy with our <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/utilities/text/#text-alignment">text utilities</a>.</p>
