...
$strheading = 'Theme Tester: Bootstrap 4 CSS : Images';
...
<!-- Facebook -->
<meta property="og:url" content="/docs/4.0/content/images/">
...
<p>In addition to our <a href="/admin/tool/themetester/docs/4.0/utilities/borders/">border-radius utilities</a>, you can use <code class="highlighter-rouge">.img-thumbnail</code> to give an image a rounded 1px border appearance.</p>
...
<p>Align images with the <a href="/admin/tool/themetester/docs/4.0/utilities/float">helper float classes</a> or <a href="/admin/tool/themetester/docs/4.0/utilities/text/#text-alignment">text alignment classes</a>. <code class="highlighter-rouge">block</code>-level images can be centered using <a href="/admin/tool/themetester/docs/4.0/utilities/spacing/#horizontal-centering">the <code class="highlighter-rouge">.mx-auto</code> margin utility class</a>.</p>
