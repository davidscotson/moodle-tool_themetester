...
<p>Regular table background variants are not available with the dark table, however, you may use <a href="/admin/tool/themetester/docs/4.0/utilities/colors/">text or background utilities</a> to achieve similar styles.</p>
