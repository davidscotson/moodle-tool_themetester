...
<p>Using the <a href="/admin/tool/themetester/docs/4.0/components/card/">card</a> component, you can extend the default collapse behavior to create an accordion.</p>
