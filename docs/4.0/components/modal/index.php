...
<ul>
  ...
  <li>Once again, due to <code class="highlighter-rouge">position: fixed</code>, there are some caveats with using modals on mobile devices. <a href="/admin/tool/themetester/docs/4.0/getting-started/browsers-devices/#modals-and-dropdowns-on-mobile">See our browser support docs</a> for details.</li>
...
<p><a href="/admin/tool/themetester/docs/4.0/components/tooltips/">Tooltips</a> and <a href="/admin/tool/themetester/docs/4.0/components/popovers/">popovers</a> can be placed within modals as needed. When modals are closed, any tooltips and popovers within are also automatically dismissed.</p>
