...
$strheading = 'Theme Tester: Bootstrap 4 CSS : Scrollspy';
...
<ul>
  ...
  <li>It must be used on a Bootstrap <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/components/navs/">nav component</a> or <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/components/list-group/">list group</a>.</li>
