...
<ul>
  ...
  <li>If you’re building our JavaScript from source, it <a href="/admin/tool/themetester/docs/4.0/getting-started/javascript/#util">requires <code class="highlighter-rouge">util.js</code></a>. The compiled version includes this.</li>
