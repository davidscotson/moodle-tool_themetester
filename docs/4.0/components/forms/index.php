...
<p>Bootstrap’s form controls expand on <a href="/admin/tool/themetester/docs/4.0/content/reboot/#forms">our Rebooted form styles</a> with classes. Use these classes to opt into their customized displays for a more consistent rendering across browsers and devices.</p>
...
<ul>
  <li>Controls are <code class="highlighter-rouge">display: flex</code>, collapsing any HTML white space and allowing you to provide alignment control with <a href="/admin/tool/themetester/docs/4.0/utilities/spacing/">spacing</a> and <a href="/admin/tool/themetester/docs/4.0/utilities/flex/">flexbox</a> utilities.</li>
