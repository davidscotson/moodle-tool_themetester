...
<p>Use our handful of <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/utilities/sizing/">available sizing utilities</a> to quickly set a card’s width.</p>
...
<p>You can quickly change the text alignment of any card—in its entirety or specific parts—with our <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/utilities/text/#text-alignment">text align classes</a>.</p>
...
<p>Add some navigation to a card’s header (or block) with Bootstrap’s <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/components/navs/">nav components</a>.</p>
...
<p>Use <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/utilities/colors/">text and background utilities</a> to change the appearance of a card.</p>
