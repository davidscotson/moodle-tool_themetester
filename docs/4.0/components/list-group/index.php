...
<p>Add badges to any list group item to show unread counts, activity, and more with the help of some <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/utilities/flex/">utilities</a>.</p>
...
<p>Add nearly any HTML within, even for linked list groups like the one below, with the help of <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0/utilities/flex/">flexbox utilities</a>.</p>
