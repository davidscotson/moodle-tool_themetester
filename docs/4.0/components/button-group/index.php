...
$strheading = 'Theme Tester: Bootstrap 4 CSS : Button group';
...
<!-- Facebook -->
<meta property="og:url" content="/docs/4.0/components/button-group/">
...
<p>Wrap a series of buttons with <code class="highlighter-rouge">.btn</code> in <code class="highlighter-rouge">.btn-group</code>. Add on optional JavaScript radio and checkbox style behavior with <a href="/admin/tool/themetester/docs/4.0/components/buttons/#button-plugin">our buttons plugin</a>.</p>
