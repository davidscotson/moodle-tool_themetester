...
$strheading = 'Theme Tester: Bootstrap 4 CSS : Brand guidelines';
...
<!-- Facebook -->
<meta property="og:url" content="/docs/4.0/about/brand/">
...
<div class="bd-brand-logos">
  <div class="bd-brand-item">
    <img class="svg" src="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/assets/brand/bootstrap-solid.svg" alt="Bootstrap" width="144" height="144" />
  </div>
  <div class="bd-brand-item inverse">
    <img class="svg" src="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/assets/brand/bootstrap-outline.svg" alt="Bootstrap" width="144" height="144" />
  </div>
</div>
<div class="bd-brand-logos">
  <div class="bd-brand-item">
...
<div class="bd-brand-logos">
  ...
  <div class="bd-brand-item inverse">
    <img class="svg" src="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/assets/brand/bootstrap-punchout.svg" alt="Bootstrap" width="144" height="144" />
  </div>
</div>
