...
<p>For a list of some of the browser bugs that Bootstrap has to grapple with, see our <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/browser-bugs/">Wall of browser bugs</a>.</p>
