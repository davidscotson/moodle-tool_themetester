...
<p>Alternatively, if you don’t need the source Sass files, you may swap the default Bootstrap compiled CSS with the compiled flexbox variation. <a href="/admin/tool/themetester/docs/4.0.0-alpha.4/getting-started/download">Head to the download page</a> for more information.</p>
