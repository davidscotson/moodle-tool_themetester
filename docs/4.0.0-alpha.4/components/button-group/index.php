  ...
  <div class="bd-toc-item ">
      ...
      <ul class="nav bd-sidenav">
        ...
        <div class="col-xs-12 col-md-9 pull-md-3 bd-content">
          ...
          <p>Group a series of buttons together on a single line with the button group. Add on optional JavaScript radio and checkbox style behavior with <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/components/buttons/#button-plugin">our buttons plugin</a>.</p>
