...
<p>Scrollspy currently requires the use of a <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/components/navs/">Bootstrap nav component</a> for proper highlighting of active links.</p>
