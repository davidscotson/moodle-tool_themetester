...
<p>Add dropdown menus with a little extra HTML and the <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/components/dropdowns/#usage">dropdowns JavaScript plugin</a>.</p>
