...
<p>You can quickly change the text alignment of any card—in its entirety or specific parts—with our <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/components/utilities/#text-alignment">text align classes</a>.</p>
...
<p><strong>ProTip!</strong> If you enable <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/getting-started/flexbox/">flexbox mode</a>, you can remove the <code class="highlighter-rouge">.card-deck-wrapper</code>.</p>
