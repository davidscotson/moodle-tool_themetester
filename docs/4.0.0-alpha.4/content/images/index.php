  ...
  <div class="bd-toc-item ">
      ...
      <ul class="nav bd-sidenav">
        ...
        <div class="col-xs-12 col-md-9 pull-md-3 bd-content">
          ...
          <p>Opt your images into responsive behavior (so they never become larger than their parent elements) and add lightweight styles to them—all via classes.</p>

<h2 id="contents">Contents</h2>

<ul id="markdown-toc">
  <li><a href="#contents" id="markdown-toc-contents">Contents</a></li>
  <li><a href="#responsive-images" id="markdown-toc-responsive-images">Responsive images</a></li>
  <li><a href="#image-shapes" id="markdown-toc-image-shapes">Image shapes</a></li>
  <li><a href="#aligning-images" id="markdown-toc-aligning-images">Aligning images</a></li>
</ul>
...
<h4 id="svg-images-and-ie-9-10">SVG images and IE 9-10</h4>

<p>In Internet Explorer 9-10, SVG images with <code class="highlighter-rouge">.img-fluid</code> are disproportionately sized. To fix this, add <code class="highlighter-rouge">width: 100% \9;</code> where necessary. This fix improperly sizes other image formats, so Bootstrap doesn’t apply it automatically.</p>
</div>

<h2 id="image-shapes">Image shapes</h2>

<p>Add classes to an <code class="highlighter-rouge">&lt;img&gt;</code> element to easily style images in any project.</p>
...
<p>Align images with the <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/components/utilities/#responsive-floats">helper float classes</a> or <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/components/utilities/#text-alignment">text alignment classes</a>. <code class="highlighter-rouge">block</code>-level images can be centered using <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/components/utilities/#horizontal-centering">the <code class="highlighter-rouge">.m-x-auto</code> margin utility class</a>.</p>
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;img</span> <span class="na">src=</span><span class="s">"..."</span> <span class="na">class=</span><span class="s">"img-rounded pull-xs-left"</span> <span class="na">alt=</span><span class="s">"..."</span><span class="nt">&gt;</span>
<span class="nt">&lt;img</span> <span class="na">src=</span><span class="s">"..."</span> <span class="na">class=</span><span class="s">"img-rounded pull-xs-right"</span> <span class="na">alt=</span><span class="s">"..."</span><span class="nt">&gt;</span></code></pre></figure>
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;img</span> <span class="na">src=</span><span class="s">"..."</span> <span class="na">class=</span><span class="s">"img-rounded m-x-auto d-block"</span> <span class="na">alt=</span><span class="s">"..."</span><span class="nt">&gt;</span></code></pre></figure>
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"text-xs-center"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;img</span> <span class="na">src=</span><span class="s">"..."</span> <span class="na">class=</span><span class="s">"img-rounded"</span> <span class="na">alt=</span><span class="s">"..."</span><span class="nt">&gt;</span>
