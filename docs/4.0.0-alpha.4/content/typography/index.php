  ...
  <div class="bd-toc-item ">
      ...
      <ul class="nav bd-sidenav">
        ...
        <div class="col-xs-12 col-md-9 pull-md-3 bd-content">
          ...
          <p>Bootstrap includes simple and easily customized typography for headings, body text, lists, and more. For even more control, check out the <a href="/admin/tool/themetester/docs/4.0.0-alpha.4/components/utilities/">textual utility classes</a>.</p>
...
<p>Change text alignment, transform, style, weight, and color with our <a href="/admin/tool/themetester/docs/4.0.0-alpha.4/components/utilities/#text-alignment">text utilities</a>.</p>
