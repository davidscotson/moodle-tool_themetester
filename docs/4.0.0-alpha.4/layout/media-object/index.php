...
<p><strong>Heads up!</strong> When <a href="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/getting-started/flexbox/">flexbox mode</a> is enabled, the media object will use <code class="highlighter-rouge">flex</code> styles wherever possible.</p>
</div>
