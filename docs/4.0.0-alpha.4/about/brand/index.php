...
<div class="bd-brand-logos">
  <div class="bd-brand-item">
    <img class="svg" src="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/assets/brand/bootstrap-solid.svg" alt="Bootstrap" width="144" height="144" />
  </div>
  <div class="bd-brand-item inverse">
    <img class="svg" src="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/assets/brand/bootstrap-outline.svg" alt="Bootstrap" width="144" height="144" />
  </div>
  <div class="bd-brand-item inverse">
    <img class="svg" src="<?php echo $CFG->wwwroot ?>/admin/tool/themetester/docs/4.0.0-alpha.4/assets/brand/bootstrap-punchout.svg" alt="Bootstrap" width="144" height="144" />
  </div>
</div>
