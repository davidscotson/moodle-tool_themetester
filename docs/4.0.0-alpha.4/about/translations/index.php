...
<ul>
  ...
  <li><a href="http://v4.bootcss.com/" hreflang="zh">Bootstrap 中文文档 (Chinese)</a></li>

  <li><a href="http://boot4.com/" hreflang="zh">Bootstrap 4 中文文档教程 (Chinese)</a></li>

  <li><a href="http://bootstrap4.jp/" hreflang="ja">Bootstrap 4 日本語リファレンス (Japanese)</a></li>
